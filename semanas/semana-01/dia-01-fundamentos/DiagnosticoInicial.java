public class DiagnosticoInicial{
    public static void main(String[] args){
        ...
        double salarioInicial = 1619;
        int anoTerminoFaculdade = 26 + 2;
        ...
        System.out.println("Idade para o término da faculdade = "+anoTerminoFaculdade+" anos");
        System.out.println();

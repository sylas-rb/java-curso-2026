...
*/
public class DiagnosticoInicial{                                                                   public static void main(String[] args){                                                        //String para texto humano                                                                 //String é uma classe, então podemos fazer algumas operações nos textos                    String nome;
            ...
            int idade;
            //Utilizando o double para guarda números decimais maiores que o float pode não sup    ortar                                                                                         double salarioInicial;                                                                     int anoTerminoFaculdade;
           String cargo = "indefinido";                                                               //Utilizando de if - else para uma lógica simples de cargo sobre o usuário                 //Utilizando println para que o próximo texto seja mostrado em baixo                       if (salarioInicial < 0) {
                System.out.println("Salario não pode ser negativo");
            }else if (salarioInicial >= 1600 && salarioInicial < 2000) {                                       System.out.println("O usuário que ser um estágiario");                                     cargo = "Estágiario";                                                             }else if (salarioInicial > 2000) {                                                                 System.out.println("O usuario que ser algo além de estágiario");
                   cargo = "Júnior";
           }else {
